package com.dxinfo.slider.library.SliderTypes;
...
//    private Picasso mPicasso;
    ...
    protected void bindEventAndShow(final View v, final SimpleDraweeView targetImageView){
        ...
        Uri uri = null;
        if(mUrl!=null){
            uri = android.net.Uri.parse(mUrl);
        }else if(mFile != null){
            uri = android.net.Uri.fromFile(mFile);
        }else if(mRes != 0){
            uri = new Uri.Builder()
                    .scheme(UriUtil.LOCAL_RESOURCE_SCHEME) // "res"
                    .path(String.valueOf(mRes))
                    .build();
        }else{
            return;
        }
        ...
        ControllerListener listener = new BaseControllerListener<ImageInfo>() {
            ...
            public void onIntermediateImageSet(String id, @Nullable ImageInfo imageInfo) {
                updateViewSizeRatio(targetImageView, imageInfo);
            }
        ...
        DraweeController loader;
//        if (mImageLoader != null) {
//            loader = mImageLoader;
//            loader.
//        }
//        else {
            loader = Fresco.newDraweeControllerBuilder()
...
//        }
        ...
        targetImageView.setController(loader);
...
//        });
    ...
    public static void updateViewSize(SimpleDraweeView draweeView, @Nullable ImageInfo imageInfo) {
        if (imageInfo != null) {
    ...
    public static void updateViewSizeRatio(SimpleDraweeView draweeView, @Nullable ImageInfo imageInfo) {
        if (imageInfo != null) {
            float ratio = (float) imageInfo.getWidth() / imageInfo.getHeight();
            //draweeView.getLayoutParams().width = imageInfo.getWidth();
            draweeView.getLayoutParams().height = (int) (draweeView.getLayoutParams().width / ratio);
