package com.dxinfo.slider.library.Indicators;
...
import com.dxinfo.slider.library.Tricks.InfinitePagerAdapter;
import com.dxinfo.slider.library.Tricks.ViewPagerEx;
import com.dxinfo.slider.library.SliderAdapter;
...
public class PagerIndicator extends LinearLayout implements ViewPagerEx.OnPageChangeListener{
    ...
    public PagerIndicator(Context context, AttributeSet attrs) {
        ...
        final TypedArray attributes = context.obtainStyledAttributes(attrs, com.dxinfo.slider.library.R.styleable.PagerIndicator,0,0);

        int visibility = attributes.getInt(com.dxinfo.slider.library.R.styleable.PagerIndicator_visibility,IndicatorVisibility.Visible.ordinal());
        ...
        int shape = attributes.getInt(com.dxinfo.slider.library.R.styleable.PagerIndicator_shape, Shape.Oval.ordinal());
        ...
        mUserSetSelectedIndicatorResId = attributes.getResourceId(com.dxinfo.slider.library.R.styleable.PagerIndicator_selected_drawable,
                0);
        mUserSetUnSelectedIndicatorResId = attributes.getResourceId(com.dxinfo.slider.library.R.styleable.PagerIndicator_unselected_drawable,
                0);

        mDefaultSelectedColor = attributes.getColor(com.dxinfo.slider.library.R.styleable.PagerIndicator_selected_color, Color.rgb(255, 255, 255));
        mDefaultUnSelectedColor = attributes.getColor(com.dxinfo.slider.library.R.styleable.PagerIndicator_unselected_color, Color.argb(33,255,255,255));

        mDefaultSelectedWidth = attributes.getDimension(com.dxinfo.slider.library.R.styleable.PagerIndicator_selected_width,(int)pxFromDp(6));
        mDefaultSelectedHeight = attributes.getDimensionPixelSize(com.dxinfo.slider.library.R.styleable.PagerIndicator_selected_height,(int)pxFromDp(6));

        mDefaultUnSelectedWidth = attributes.getDimensionPixelSize(com.dxinfo.slider.library.R.styleable.PagerIndicator_unselected_width,(int)pxFromDp(6));
        mDefaultUnSelectedHeight = attributes.getDimensionPixelSize(com.dxinfo.slider.library.R.styleable.PagerIndicator_unselected_height,(int)pxFromDp(6));

        mSelectedGradientDrawable = new GradientDrawable();
        mUnSelectedGradientDrawable = new GradientDrawable();

        mPadding_left = attributes.getDimensionPixelSize(com.dxinfo.slider.library.R.styleable.PagerIndicator_padding_left,(int)pxFromDp(3));
        mPadding_right = attributes.getDimensionPixelSize(com.dxinfo.slider.library.R.styleable.PagerIndicator_padding_right,(int)pxFromDp(3));
        mPadding_top = attributes.getDimensionPixelSize(com.dxinfo.slider.library.R.styleable.PagerIndicator_padding_top,(int)pxFromDp(0));
        mPadding_bottom = attributes.getDimensionPixelSize(com.dxinfo.slider.library.R.styleable.PagerIndicator_padding_bottom,(int)pxFromDp(0));

        mSelectedPadding_Left = attributes.getDimensionPixelSize(com.dxinfo.slider.library.R.styleable.PagerIndicator_selected_padding_left,(int)mPadding_left);
        mSelectedPadding_Right = attributes.getDimensionPixelSize(com.dxinfo.slider.library.R.styleable.PagerIndicator_selected_padding_right,(int)mPadding_right);
        mSelectedPadding_Top = attributes.getDimensionPixelSize(com.dxinfo.slider.library.R.styleable.PagerIndicator_selected_padding_top,(int)mPadding_top);
        mSelectedPadding_Bottom = attributes.getDimensionPixelSize(com.dxinfo.slider.library.R.styleable.PagerIndicator_selected_padding_bottom,(int)mPadding_bottom);

        mUnSelectedPadding_Left = attributes.getDimensionPixelSize(com.dxinfo.slider.library.R.styleable.PagerIndicator_unselected_padding_left,(int)mPadding_left);
        mUnSelectedPadding_Right = attributes.getDimensionPixelSize(com.dxinfo.slider.library.R.styleable.PagerIndicator_unselected_padding_right,(int)mPadding_right);
        mUnSelectedPadding_Top = attributes.getDimensionPixelSize(com.dxinfo.slider.library.R.styleable.PagerIndicator_unselected_padding_top,(int)mPadding_top);
        mUnSelectedPadding_Bottom = attributes.getDimensionPixelSize(com.dxinfo.slider.library.R.styleable.PagerIndicator_unselected_padding_bottom,(int)mPadding_bottom);
